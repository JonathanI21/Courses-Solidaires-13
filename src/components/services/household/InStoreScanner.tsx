  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
        ...
        {/* PARTIE GAUCHE - Scanner avec caméra réelle */}
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <div className="space-y-4">
              <div className="text-center">
                <Camera className="mx-auto text-emerald-500 mb-3" size={48} />
              ...
              <div className="grid grid-cols-2 gap-3">
                {scannerTypes.map(scanner => (
                  <button
                    ...
                    className={`p-4 border-2 rounded-lg hover:border-emerald-500 hover:bg-emerald-50 transition-all text-center ${
                      scanner.id === 'classic' ? 'border-emerald-300' : 'border-blue-300'
                    }`}
                  >
                    {scanner.icon}
                    <div className="font-medium text-gray-800">{scanner.name}</div>
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    onClick={onRectifyList}
                    className="flex items-center px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg hover:bg-emerald-200 transition-colors text-sm"
                  >
                    <Edit3 className="mr-1" size={14} />
                    Rectifier
                  </button>
